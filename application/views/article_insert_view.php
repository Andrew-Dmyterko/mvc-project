<?php
// Формируем view добавления новой статьи
...
<!--    <div class="jumbotron jumbotron-fluid">-->
    ...
    <div class="jumbotron col-xs-110 col-sm-10 col-md-10 col-lg-10" style="margin-right: auto; margin-left: auto;">
        ...
        <p class="lead"><em>Пожалуйста внесите данные новой статьи и нажмите <u>"Добавить статью"</u></em></p>
        <div class="row justify-left-left">
            <form class="col-sm-12" id="main-form" name="form" method="post" enctype="multipart/form-data" action="http://<?=SITE_NAME?>/Article/insertAdd/">
